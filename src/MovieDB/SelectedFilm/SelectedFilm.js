                ...
                <div className={style.total}>
                    ...
                    <div className={style.details}>
                        ...
                        <div className={style.score}>
                            <div className={style.scoreText}> Оценка: {info?.vote_average}</div>
                            <div className={style.scoreText}> Дата выхода: {info?.release_date}</div>
                            <div className={style.scoreText}> Продолжительность: {info?.runtime} мин.</div>
                        </div>
